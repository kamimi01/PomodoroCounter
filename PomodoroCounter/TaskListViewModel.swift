...
//    ]
//    @Published var taskList: [TaskModel] = []
    @Published var taskList: [TaskModel] = [TaskModel(id: "1", title: "テレアカの要件定義をする。要件定義をする", detail: "xxの要件を明確にし、工数の見積もりができるようにする", totalNumOfPomodoro: 20, completedNumOfPomodoro: 17, numOfInterruption: 2)]
}
